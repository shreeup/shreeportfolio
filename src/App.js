...
function App() {
    ...
    const submitquery = (e) => {
        ...
        emailjs.sendForm('service_6s82y6l', 'template_035neu8', cform.current, 'QHu46_PYmVxUGI88J').then(res => {
            ...
            document.getElementById('thank-you-message').innerHTML = 'Thank you for contacting me. I will be in touch with you very soon.';
            setTimeout(() => {
                document.getElementById('thank-you-message').innerHTML = "";
            }, 2000);

        }).catch(err => {
            document.getElementById('thank-you-message').innerHTML = 'Could not process the message. Please contact by LinkedIn.';
            setTimeout(() => {
                document.getElementById('thank-you-message').innerHTML = "";
            }, 2000);
            ...
            <main>
                <section className="container about" id="about">
                    ...
                    <div className="about-stats">
                        <h4 className="stat-title">Certifications</h4>
                        <center><ul>
                            <li>AWS Certified Developer Associate – Certified 2022</li>
                            <li>Microsoft® Certified Solutions Associate: Web Applications - Certified 2019</li>
                            <li>Microsoft Technology Associate: Software Development Fundamentals - Certified 2016</li>
                        </ul></center>
                    </div>
                    <div className="about-stats">
